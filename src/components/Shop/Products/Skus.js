 ...
 * Date: 12/21/2019 09:57 AM
 * Relative Path: src/components/Shop/Products/Skus.js
 * Description: Renders Sku's for product
 */
...
class Skus extends Component {
	...
	componentDidMount() {
		const stripe = window.Stripe('pk_test_dvbj8EdCZ1MSrA65EHRDCBtg');
