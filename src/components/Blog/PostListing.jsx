 ...
 * Date: 12/23/2019 11:22 AM
 * Project: react-static-ecommerce-blog - a site built for gatsby
 * GitRepo: https://github.com/hereiamnow/react-static-ecommerce-blog.git
 * Relative Path: src/components/Blog/PostListing.jsx
						...
						<div className="blog-feature-content">
							...
							<div className="blog-footer-2 border-color-theme">
								<ul>
									...
									<li>
										Category:&nbsp;
										<span><Link to={`/blog/categories/${_.kebabCase(post.category)}/`} className="hover-text-theme">{post.category}</Link></span>
									</li>
									<li>
										Tags: {post.tags.map(tag => (
										<span key={tag}>&nbsp;
											<Link to={`/blog/tags/${_.kebabCase(tag)}/`} className="hover-text-theme">{tag}</Link></span>
									))}
									</li>
