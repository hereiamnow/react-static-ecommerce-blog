...
class ConsumerDonation extends React.Component {
	...
	render () {
		...
		return (
				<Layout location={location} crumbLabel={"Consumer Donation"}>
					<Helmet title={`Consumer Donation | ${config.siteTitle}`} />
					<SubHeader title={`Consumer Donation | ${config.siteTitle}`} crumbLabel="Donation" crumbLink="/donate/consumer" />
								...
								<Col md={7}>
									<div className="product-detail-warp">
										...
										<div className="product-title">
											<h2>{config.siteTitle} Consumer Donation</h2>
										</div>
...
export default ConsumerDonation;
